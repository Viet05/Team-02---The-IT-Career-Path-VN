...
public class UserFavouriteJobService {
        ...
        public UserFavouriteJobResponse addUserFavouriteJob(UserFavouriteJobAddRequest request, Long userId) {
                ...
                boolean exists = userFavouriteJobRepository.existsByUsers_UserIdAndJobPosting_JobPostingId(userId,
                                request.getJobPostingId());
                if (exists) {
                        throw new DuplicateResourceException("UserFavoriteJob", "jobPostingId",
                                        request.getJobPostingId());
                }
                ...
                return UserFavouriteJobResponse.builder()
                                ...
                                .jobPosting(JobPostingMapper.toListResponse(jobPosting))
                                .userId(userId)
                                .build();
        }
        ...
        public List<UserFavouriteJobResponse> getUserFavouriteJobs(Long userId) {
                ...
                return userFavouriteJobRepository.findByUsers_UserId(userId)
                                ...
                                .map(userFavoriteJob -> new UserFavouriteJobResponse(
                                                ...
                                                JobPostingMapper.toListResponse(userFavoriteJob.getJobPosting()),
        ...
        public void deleteUserFavouriteJob(Long userId, Long userFavoriteJobId) {
                ...
                UserFavoriteJob userFavoriteJob = userFavouriteJobRepository.findById(userFavoriteJobId).orElseThrow(
                                () -> new ResourceNotFoundException("UserFavoriteJob", "id", userFavoriteJobId));
